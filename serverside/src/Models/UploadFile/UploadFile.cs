...
namespace My2000thapp.Models
{
	...
	public class UploadFile : IAbstractModel
	{
		...
		public async Task BeforeSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, CancellationToken cancellationToken = default)
		{
			return;
		}

		public async Task AfterSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, ICollection<ChangeState> changes, CancellationToken cancellationToken = default)
		{

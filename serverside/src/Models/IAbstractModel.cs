...
namespace My2000thapp.Models {
	...
	public interface IAbstractModel
	{
		...
		Task BeforeSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, CancellationToken cancellationToken = default);
		Task AfterSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, ICollection<ChangeState> changes, CancellationToken cancellationToken = default);

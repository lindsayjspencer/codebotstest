...
using My2000thapp.Enums;
using My2000thapp.Security;
using My2000thapp.Validators;
...
namespace My2000thapp.Models {
	public class User : IdentityUser<Guid>, IOwnerAbstractModel
	{
		...
		public virtual async Task BeforeSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, CancellationToken cancellationToken = default)
		{
			// % protected region % [Add any before save logic here] off begin
			// % protected region % [Add any before save logic here] end
		}

		public virtual async Task AfterSave(EntityState operation, My2000thappDBContext dbContext, IServiceProvider serviceProvider, ICollection<ChangeState> changes, CancellationToken cancellationToken = default)
		{
		...
		public async virtual Task<int> CleanReference<T>(
			...
			My2000thappDBContext dbContext,

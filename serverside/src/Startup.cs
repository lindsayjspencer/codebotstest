...
using My2000thapp.Configuration;
using My2000thapp.Models;
using My2000thapp.Services;
using My2000thapp.Helpers;
using My2000thapp.Utility;
using My2000thapp.Graphql;
using My2000thapp.Graphql.Types;
using My2000thapp.Controllers;
using My2000thapp.Services.Scheduling;
using My2000thapp.Services.CertificateProvider;
using My2000thapp.Services.Interfaces;
using My2000thapp.Services.Files;
using My2000thapp.Services.Files.Providers;
using Serilog;
	...
	public class Startup
	{
		...
		public IServiceProvider ConfigureServices(IServiceCollection services)
		{
			...
			Log.Logger = new LoggerConfiguration()
				...
				.Enrich.WithProperty("Application", "My2000thapp")
				.WriteTo.Console()
				.CreateLogger();
			...
			{
				options.InvalidModelStateResponseFactory = ctx => new My2000thappActionResult();
			});
		...
		private void ConfigureDatabaseConnection(IServiceCollection services)
		{
			...
			services.AddDbContext<My2000thappDBContext>(options =>
			{
		...
		private void AddSwaggerService(IServiceCollection services)
		{
			...
			{
				options.SwaggerDoc("json", new OpenApiInfo {Title = "My2000thapp", Version = "v1"});
		...
		private void ConfigureAuthServices(IServiceCollection services)
		{
			...
			services.AddDataProtection()
				.PersistKeysToDbContext<My2000thappDBContext>();
			...
			services.AddIdentity<User, Group>(options =>
				...
				.AddEntityFrameworkStores<My2000thappDBContext>()
			...
			services.AddOpenIddict()
				.AddCore(options =>
				{
					options.UseEntityFrameworkCore()
						.UseDbContext<My2000thappDBContext>()
		...
		private void ConfigureGraphql(IServiceCollection services)
		{
			...
			services.TryAddSingleton<ISchema, My2000thappSchema>();
			services.TryAddSingleton<My2000thappQuery>();
			services.TryAddSingleton<My2000thappMutation>();
			...
			EfGraphQLConventions.RegisterInContainer<My2000thappDBContext>(services);
			...
			ILogger<AuditLog> logger)
		{
			...
			{
				options.SwaggerEndpoint("/api/swagger/json/openapi.json", "My2000thapp");

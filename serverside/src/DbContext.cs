...
namespace My2000thapp.Models {
	...
	public class My2000thappDBContext : AuditIdentityDbContext<User, Group, Guid>, IDataProtectionKeyContext
	// % protected region % [Change the class signature here] end
	{
		private readonly ILogger<My2000thappDBContext> _logger;
		...
		public My2000thappDBContext(
			...
			DbContextOptions<My2000thappDBContext> options,
			IHttpContextAccessor httpContextAccessor,
			ILogger<My2000thappDBContext> logger) : base(options)
		{
			_logger = logger;

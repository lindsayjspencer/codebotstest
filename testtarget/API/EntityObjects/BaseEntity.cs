...
using My2000thappDBContext = My2000thapp.Models.My2000thappDBContext;
using RestSharp;
...
namespace APITests.EntityObjects.Models
{
	...
	public abstract class BaseEntity
	{
		...
		internal Guid SaveToDB<T>(T model) where T : class, My2000thapp.Models.IOwnerAbstractModel
		{
			var configure = new StartupTestFixture();
			// % protected region % [Adjust the db context if required] off begin
			var context = new My2000thappDBContext(configure.DbContextOptions, null, null);

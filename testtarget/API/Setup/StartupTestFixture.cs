...
namespace APITests.Setup
{
	public class StartupTestFixture
	{
		...
		public DbContextOptions<My2000thappDBContext> DbContextOptions {get;}
		...
		public StartupTestFixture()
		{
			...
			AppSettings = new ConfigurationBuilder()
				...
				.AddEnvironmentVariables("My2000thapp_")
				.AddEnvironmentVariables($"My2000thapp_Test_")
				.Build();
			...
			DbContextOptions = new DbContextOptionsBuilder<My2000thappDBContext>()
			...
			using (var context = new My2000thappDBContext(DbContextOptions, null, null))
			{
